        ...
        <div className="grid gap-4 mt-9 grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          {cats.map((c, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="relative h-[340px] rounded-[22px] overflow-hidden cursor-pointer text-white group"
            >
              <Image
                src={c.img}
                alt={c.t}
              ...
              <div className="absolute left-[18px] bottom-[18px] right-[18px] z-[2]">
                ...
                <div className="font-display text-[22px] tracking-[-0.02em] leading-[1.1]">{c.t}</div>
              </div>
            </motion.div>
          ))}
        </div>
